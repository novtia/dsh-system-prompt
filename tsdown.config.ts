/**
 * Browser client bundle. Mirrors the dsh-market / harness client preset for an
 * out-of-tree package: a closure-factory artifact that calls
...
export default defineConfig({
  ...
  plugins: [{
    name: 'dsh-client-externals',
    resolveId: {
      order: 'pre' as const,
      handler(source: string) {
        return CLIENT_EXTERNALS.includes(source) ? { id: source, external: true } : null
      },
    },
  }, {
